...
Transmission.prototype.add = function(path, options, callback) {
    // for retro-compatibility with old method
...
Transmission.prototype.addFile = function(filePath, options, callback) {
	...
	fs.readFile(filePath, function(err, data){
	    ...
	    self.addArgs(args, options, callback);
	});
}
Transmission.prototype.addUrl = function(url, options, callback) {
    var args = {};
    args['filename'] = url
    this.addArgs(args, options, callback);
}
Transmission.prototype.addArgs = function(args, options, callback) {
	if ( typeof options === 'function') {
		callback = options;
	} else {
		if ( typeof options === 'object') {
